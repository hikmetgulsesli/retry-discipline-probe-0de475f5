...
- Retry Discipline Probe turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page utility called Retry Discipline Probe. It should show three compact status tiles, one Refresh button that updates a timestamp and activity row, and one Ready/Paused toggle persisted in localStorage. Keep it simple and polished.
...
- Status Utility - Retry Discipline Probe

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Status Utility - Retry Discipline Probe
